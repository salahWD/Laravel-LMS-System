      ...
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-12">
          ...
          <div class="card card-stepper" style="border-radius: 16px;">
            <div class="card-body p-5">
              <div class="d-flex mb-5 invoice justify-content-between align-items-center">
                <div class="title">
                  <h5 class="mb-0">INVOICE <span
                      class="text-primary font-weight-bold">#{{ strtoupper($order->token) }}</span></h5>
                </div>
              ...
              <div class="max-sm-flex-col">
                <ul class="progressbar d-flex justify-content-between mx-0 mt-0 mb-5 px-0 pt-0 pb-2">
                  <li
                    class="step @if ($order->stage >= 1) active @endif text-center d-flex align-items-center @if ($order->stage >= 1) fas fa-check-circle @else fa-regular fa-circle @endif"
                    id="step1"></li>
                  <li
                    class="step @if ($order->stage >= 2) active @endif text-center d-flex align-items-center @if ($order->stage >= 2) fas fa-check-circle @else fa-regular fa-circle @endif"
                    id="step2"></li>
                  <li
                    class="step @if ($order->stage >= 3) active @endif text-center d-flex align-items-center @if ($order->stage >= 3) fas fa-check-circle @else fa-regular fa-circle @endif"
                    id="step3"></li>
                  <li
                    class="step @if ($order->stage >= 4) active @endif text-center d-flex align-items-center @if ($order->stage >= 4) fas fa-check-circle @else fa-regular fa-circle @endif"
                    id="step4"></li>
                </ul>
            ...
            @if ($products->count() > 0)
              <div
                style="margin: 4rem auto; width: 100%; overflow: hidden; border-radius: 0.5rem; --tw-bg-opacity: 1; padding-left: 1rem; padding-right: 1rem;">
                <div
                  style="display: block; border-radius: 0.5rem; border-width: 1px; --tw-border-opacity: 1; border-color: rgb(156 163 175 / var(--tw-border-opacity)); --tw-bg-opacity: 1;">
                  <div
                    style="border-bottom-width: 2px; --tw-border-opacity: 1; border-color: rgb(245 245 245 / var(--tw-border-opacity)); padding: 0.75rem 1.5rem;">
                    <div
                      style="display: flex; align-items: center; justify-content: space-between; --tw-bg-opacity: 1; background-color: rgb(243 244 246 / var(--tw-bg-opacity)); padding: 0.75rem 2.5rem;">
                      <h3
                        style="font-size: inherit; font-weight: 600; margin: 0px; --tw-text-opacity: 1; color: rgb(17 24 39 / var(--tw-text-opacity));">
                      ...
                      <div style="overflow-x: auto;">
                        <div style="display: inline-block; min-width: 100%; padding-top: 0.5rem; padding-bottom: 0.5rem;">
                          <div style="overflow: hidden;">
                            <table
                              style="text-indent: 0px; border-color: inherit; border-collapse: collapse; min-width: 100%; text-align: left; font-size: 0.875rem; line-height: 1.25rem; font-weight: 300;">
                              <thead
                                style="border-bottom-width: 1px; font-size: 1rem; line-height: 1.5rem; font-weight: 500; --tw-text-opacity: 1; color: rgb(17 24 39 / var(--tw-text-opacity));">
                                <tr>
                              ...
                              <tbody
                                style="font-weight: 500; --tw-text-opacity: 1; color: rgb(31 41 55 / var(--tw-text-opacity));">
