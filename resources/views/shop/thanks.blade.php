...
@section('content')
  @php
    $link = $order != null ? route('order_tracking', $order->token) : route('my_orders');
  @endphp
  <x-status-page title="THANK YOU!" btn="Track Order" :link="$link">
    <x-slot:icon>
      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="350" height="350" viewBox="0 0 32 32">
        <path
    ...
    <x-slot:desc>
      Payment has been received successfully, the products will be prepared and shipped to you as soon as possible.
    </x-slot>
  </x-status-page>
@endsection
