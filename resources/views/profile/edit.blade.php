  ...
  <div class="w-full px-6 pb-8 mt-8 sm:max-w-xl sm:rounded-lg">
    ...
    <div class="grid max-w-2xl mx-auto mt-8">
      <div class="flex flex-col items-center space-y-5 sm:flex-row sm:space-y-0">
        ...
        <img class="object-cover w-40 h-40 p-1 rounded-full ring-2 ring-blue-500" src="{{ $user->image_url() }}"
          id="previewPicture" alt="Bordered avatar">
  ...
  deletePicture.addEventListener("click", function() {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        $("<input type='hidden' name='delete_image' value='true' />").appendTo("form#updateProfileForm");
      }
    });
  });
</script>
