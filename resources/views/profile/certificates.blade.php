...
<x-profile.layout>
  ...
  <x-slot name="meta">
    <title>{{ config('app.name') }} | {{ __('My Certificates') }}</title>
  </x-slot>

  <div class="w-full pb-6 mt-8 sm:rounded-lg">
                ...
                <div style="display:flex;flex-direction:column;flex:1 1 0%;padding:8px;">
                  <div style="position:relative;">
                    <div
                      ...
                      <img
                        src="https://d3njjcbhbojbot.cloudfront.net/api/utilities/v1/imageproxy/https://coursera-course-photos.s3.amazonaws.com/e7/ea896ef5cf43859b38b86324d64a0d/learn-imba.png?auto=format%2Ccompress%2C%20enhance&amp;dpr=1&amp;w=265&amp;h=204&amp;fit=crop&amp;q=50"
                    ...
                    <div style="display:flex;flex-direction:column;gap:8px;">
                      <div style="">
                        <a data-click-key="unified_description_page.consumer_course_page.click.collection_product_card"
                          ...
                          data-track-component="collection_product_card" data-track-href="/learn/learn-imba"
            ...
            <div
              ...
              <div
                ...
                <div style="position:relative;width: 333px;padding-bottom:215px;height:215px;">
                  <div style="box-sizing:border-box;"><img src="{{ url('images/certificates-image.png') }}"
