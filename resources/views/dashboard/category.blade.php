...
@section('content')
  ...
  <div class="container mt-4">
    <form method="POST" action="{{ isset($category->id) ? route("category_edit", $category->id) : route("category_create") }}" enctype="multipart/form-data">
      @csrf
      <div class="row">
              ...
              <div class="tab-pane fade show active" id="ar-content" role="tabpanel" aria-labelledby="ar-content-tab">
                ...
                <div class="mb-3">
                  ...
                  <textarea
                    ...
                    name="description"
                    placeholder="{{ __('a brief description about the category') }}">{{ old("description") ?? $category->description }}</textarea>
              ...
              <div class="tab-pane fade" id="en-content" role="tabpanel" aria-labelledby="en-content-tab">
                ...
                <div class="mb-3">
                  ...
                  <textarea
                    ...
                    style="min-height: 80px;"
                    name="description_en"
                    placeholder="{{ __('a brief description about the category') }}">{{ old("description_en") ?? $category->translateOrNew("en")->description }}</textarea>
            ...
            <div class="col-12 mb-4">
              <div class="card shadow border-0 text-center p-0">
                <div class="card-body pb-5">
                  ...
                  <img src="{{ $category->image_url() }}" id="categoryImagePreview" class="rounded mx-auto m-0 category-thumbnail" alt="{{ __('category Image') }}">
                  ...
                  <button type="button" onclick="document.getElementById('categoryImage').click()" class="btn btn-sm btn-warning d-inline-flex mx-3 align-items-center">
