      ...
      <table class="table table-hover">
          ...
          <tbody>
            @foreach ($orders as $order)
              ...
              <tr class="fw-normal">
                <td>
                  <a href="{{ route("user_edit", $order->id) }}">{{ $order->user != null ? $order->user->username : $order->client_name }}</a>
                </td>
                <td>
                  <a href="{{ route("user_edit", $order->id) }}">{{ $order->address }}</a>
                </td>
                ...
                <td>
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu py-0">
                      <a class="dropdown-item" href="{{ route("user_edit", $order->id) }}">
                        <span class="fa me-1">
