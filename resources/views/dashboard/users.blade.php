  ...
  <div class="container">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
      <div class="d-block mb-4 mb-md-0">
        <x-breadcrumb page="users" is-route=1 url="users_manage" />
              ...
              <tr class="fw-normal">
                <td class="p-1">
                  <a href="{{ route("user_edit", $user->id) }}">
                    <img class="ms-3 rounded-1 profile-pick" src="{{ $user->image_url() }}" alt="{{ __('user image') }}">
                  </a>
                </td>
                <td>
                  <a href="{{ route("user_edit", $user->id) }}">{{ $user->username }}</a>
                </td>
                <td>
                  <a href="{{ route("user_edit", $user->id) }}">{{ $user->email }}</a>
                </td>
                <td>{{ $user->created_at }}</td>
                <td><span class="fw-bold px-2 py-1 text-white rounded bg-{{ $user->status_class() }}">{{ $user->status_text() }}</span></td>
                <td>
                  <div class="btn-group">
