  ...
  <div class="container">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
      <div class="d-block mb-4 mb-md-0">
        ...
        <p class="mb-0">{{ __('manage :page from one place.', ['page' => __('All :item', ['item' => __('Products')])]) }}
        </p>
      </div>
            ...
            <tr class="fw-normal product-row" id="product-{{ $product->id }}" data-id="{{ $product->id }}">
              <td class="p-1">
                <a href="{{ route('product_edit', $product->id) }}">
                  <img class="ms-3 rounded-1 profile-pick" src="{{ $product->main_image_url() }}"
                ...
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu py-0">
                    ...
                    <button class="dropdown-item text-danger rounded-bottom delete-btn"
                      id="product-{{ $product->id }}-delete" data-id="{{ $product->id }}">
                      <span class="fa me-2">
                        <svg class="me-2" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor"
                          viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                          <path stroke-linecap="round" stroke-linejoin="round"
