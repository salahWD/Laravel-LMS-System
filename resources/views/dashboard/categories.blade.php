              ...
              <tr class="fw-normal category-row" id="category-{{ $category->id }}" data-id="{{ $category->id }}">
                <td class="p-1">
                  <a href="{{ route("category_edit", $category->id) }}">
                    <img class="ms-3 rounded-1 profile-pick" src="{{ $category->image_url() }}" alt="{{ __('category image') }}">
                  </a>
                </td>
                <td class="wrap">
                ...
                <td>
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu py-0">
                      ...
                      <hr class="my-0">
                      <button class="dropdown-item text-danger rounded-bottom delete-btn" id="category-{{ $category->id }}-delete" data-id="{{ $category->id }}">
                        <span class="fa me-2">
                          <svg class="me-2" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
