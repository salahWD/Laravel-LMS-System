        ...
        <div class="col-12 col-xl-7">
          <div class="card card-body border-0 shadow mb-4">
            ...
            <div class="mb-3">
              ...
              @error('title')<div class="invalid-feedback">{{ $message }}</div>{{ __('@enderror') }}
            </div>
            <div class="mb-3">
              ...
              <input
                ...
                placeholder="{{ __('how the tag will appear in url') }}">
              @error('slug')<div class="invalid-feedback">{{ $message }}</div>{{ __('@enderror') }}
            </div>
            <div class="mb-3">
              ...
              <textarea
                ...
                name="description"
                placeholder="description won't be displayed to users">{{ old("description") ?? $tag->description }}</textarea>
              @error('description')<div class="invalid-feedback">{{ $message }}</div>{{ __('@enderror') }}
            </div>
            <hr>
