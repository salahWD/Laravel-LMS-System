  ...
  <div class="sidebar-inner px-4 pt-3">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <li class="nav-item">
        ...
        <div
          class="multi-level collapse {{ in_array(request()->segment(3), ['articles', 'categories', 'comments', 'tags']) ? 'show' : '' }}"
      ...
      <li class="nav-item">
        ...
        <div
          class="multi-level collapse {{ in_array(request()->segment(3), ['courses', 'lectures', 'tests', 'certificates']) ? 'show' : '' }}"
      ...
      <li class="nav-item">
        ...
        <div
          class="multi-level collapse {{ in_array(request()->segment(3), ['products', 'pcategories', 'orders']) ? 'show' : '' }}"
      ...
      <li class="nav-item {{ request()->segment(3) == 'appointments' ? 'active' : '' }}">
        <a href="{{ route('appointments_manage') }}" class="nav-link">
          <span class="sidebar-icon">
          ...
          <span class="sidebar-text text-capitalize">{{ __('appointments') }}</span>
        </a>
      </li>
