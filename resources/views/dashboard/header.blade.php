    ...
    <div class="sidebar-inner px-4 pt-3">
            ...
            <div class="d-flex align-items-center">
                <div class="avatar-lg me-4">
                    <img src="{{ url('img/team/profile-picture-3.jpg') }}"
                        class="card-img-top rounded-circle border-white" alt="{{ __('Bonnie Green') }}">
                </div>
                <div class="d-block">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse {{ in_array(request()->segment(3), ['articles', 'categories', 'comments', 'tags']) ? 'show' : '' }}"
                    role="list" id="submenu-articles">
            ...
            <li class="nav-item">
                <span
                    ...
                    data-bs-toggle="collapse" data-bs-target="#submenu-teaching"
                ...
                <div class="multi-level collapse {{ in_array(request()->segment(3), ['courses', 'lectures', 'tests', 'certificates']) ? 'show' : '' }}"
                    role="list" id="submenu-teaching">
                    <ul class="flex-column nav">
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse {{ in_array(request()->segment(3), ['products', 'pcategories', 'orders']) ? 'show' : '' }}"
                    ...
                    <ul class="flex-column nav">
                        ...
                        <li
                            class="nav-item {{ request()->segment(4) == null && request()->segment(3) == 'products' ? 'active' : '' }}">
            ...
            <li class="nav-item {{ request()->segment(3) == 'meetings' ? 'active' : '' }}">
                <a href="{{ route('meetings_manage') }}" class="nav-link">
                    <span class="sidebar-icon">
                        <svg fill="currentColor" class="icon icon-xs me-2" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 448 512">
                            <path
                                d="M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" />
                        </svg>
                    </span>
                    <span class="sidebar-text text-capitalize">{{ __('meetings') }}</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="https://t.me/salahbakhash" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon">
                        <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
