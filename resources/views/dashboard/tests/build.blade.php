        ...
        <div class="test-create-page">
            ...
            <div class="row p-0 m-0">
                ...
                <div class="col" id="main">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="main_modal" data-bs-backdrop="static" data-bs-keyboard="false"
                        tabindex="-1">
                        <div class="modal-dialog modal-dialog-scrollable modal-xl">
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-0">
                                    <div class="row m-0">
                                        <div class="col-4 pr-0 bg-light">
                                            <div id="modal_sidebar" class="p-3"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" id="submit_modal"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" value="{{ $test->title }}" id="testTitle"
                    ...
                    <div class="py-4">
                        <div class="title mb-0">
                            ...
                            <button class="btn py-1 px-2 text-muted" data-bs-toggle="modal"
                                data-bs-target="#TitleEditModal">
                                <i class="fa fa-edit"></i>
                            </button>
                            <button class="btn btn-sm btn-primary" id="copy-link"
                                data-value="{{ route('test_show', $test->id) }}">
                    ...
                    <div class="alert shadow alert-primary p-4" style="border-style: dashed" id="introInfo">
                        <form id="intro-form">
                            <div class="form-check form-switch p-0 my-0 d-flex gap-3">
                                ...
                                <input class="form-check-input mx-0 float-none" name="has_intro" type="checkbox"
                                    role="switch" id="intro-switch" @if ($test->has_intro()) checked @endif>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-7 d-flex flex-column align-items-center justify-content-center">
                                        <h3 class="text-dark title my-3" data-target="introTitle-input" id="introTitle">
                                            {{ $test->intro_title }}</h3>
                                        <input style="display: none" id="introTitle-input" type="text"
                                            name="intro_title" class="form-control mb-3" placeholder="intro title"
                                            value="{{ $test->intro_title }}">
                                        ...
                                        <button type="button" class="btn btn-primary py-2 px-3 mt-3"
                                            data-target="introButton-input"
                                            id="introButton">{{ $test->intro_btn }}</button>
                                        <input style="display: none" id="introButton-input" name="intro_btn"
                                            type="text" class="form-control mb-3" placeholder="intro button"
                                            value="{{ $test->intro_btn }}">
                                    </div>
                                    <div class="col-md-5">
                                        ...
                                        <input type="file" name="intro_image" id="introImage" class="d-none"
                                            accept=".jpg,.jpeg,.png">
                    ...
                    <div class="shadow alert alert-info p-4 results" style="border-style: dashed"
                        id="resultItemsContainer">
                        <form id="result-form">
                            <div id="result-holder">
                                <div id="resultInvisiblity" style="transition: all 0.2s ease;">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-6">
                                            <input value="{{ $test?->result?->min_score }}" type="number"
                                                max="{{ $test->totalScore() }}" name="min_score" id="min_score"
                                                class="form-control" placeholder="{{ __('minimum score to success') }}">
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-sm-6">
                                            <label class="title text-dark"
                                                for="min_percent">{{ __('minimum percentage') }}:</label>
                                        </div>
                                        <div class="col-sm-6">
                                            <input value="{{ $test?->result?->min_percent }}" type="number"
                                                min="0" name="min_percent" id="min_percent" class="form-control"
                                    ...
                                    @if ($test->course_id == null)
                                        <div class="row mb-2">
                                            <div class="col-sm-6">
                                                <label class="title text-dark"
                                                    for="max_attempts">{{ __('maximum attempts') }}:</label>
                                            </div>
                                            <div class="col-sm-6">
                                                <input value="{{ $test?->result?->max_attempts }}" type="number"
                                                    min="1" name="max_attempts" id="max_attempts"
                                                    class="form-control"
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-6">
                                            <input value="{{ $test?->result?->min_correct_questions }}" type="number"
                                                min="0" name="min_correct_questions" id="min_correct_questions"
                                                class="form-control"
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-sm-6">
                                            <label class="title text-dark"
                                                for="custom_note">{{ __('custom note') }}:</label>
                                        </div>
                                        <div class="col-sm-6">
                                ...
                                <div id="certificatesContainer">
                                    <div id="certificateRemovableInfo"
                                        @if ($test->has_certificate()) class="d-none" @endif>
