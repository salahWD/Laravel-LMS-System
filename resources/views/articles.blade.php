...
@section('content')
  <section class="hero-carousel mt-5" dir="ltr">
    <div class="row post-carousel-featured post-carousel">
      ...
      <div class="post featured-post-md">
        <div class="details clearfix">
          <a class='category-badge' href='category.html'>{{ __('Electronics') }}</a>
          <h4 class="post-title"><a href='blog-single.html'>{{ __('Most Burning Questions About Light Lamp') }}</a></h4>
          <ul class="meta list-inline mb-0">
      ...
      <div class="post featured-post-md">
        <div class="details clearfix">
          <a class='category-badge' href='category.html'>{{ __('Inspiration') }}</a>
          <h4 class="post-title"><a href='blog-single.html'>{{ __('9 Most Awesome Blue Lake With Snow Mountain') }}</a></h4>
          <ul class="meta list-inline mb-0">
            <li class="list-inline-item"><a href="#">{{ __('Katen Doe') }}</a></li>
            <li class="list-inline-item">{{ __('29 March 2021') }}</li>
          </ul>
      ...
      <div class="post featured-post-md">
        <div class="details clearfix">
          <a class='category-badge' href='category.html'>{{ __('Various') }}</a>
          <h4 class="post-title"><a href='blog-single.html'>{{ __('Open The Gates For Chair By Using These Tips') }}</a></h4>
          <ul class="meta list-inline mb-0">
            <li class="list-inline-item"><a href="#">{{ __('Katen Doe') }}</a></li>
            <li class="list-inline-item">{{ __('29 March 2021') }}</li>
          </ul>
      ...
      <div class="post featured-post-md">
        <div class="details clearfix">
          <a class='category-badge' href='category.html'>{{ __('Mechanics') }}</a>
          <h4 class="post-title"><a href='blog-single.html'>{{ __('Feel Like A Pro With The Help Of These 7 Tips') }}</a></h4>
          <ul class="meta list-inline mb-0">
            <li class="list-inline-item"><a href="#">{{ __('Katen Doe') }}</a></li>
            <li class="list-inline-item">{{ __('29 March 2021') }}</li>
          </ul>
      ...
      <div class="post featured-post-md">
        <div class="details clearfix">
          <a class='category-badge' href='category.html'>{{ __('Inspiration') }}</a>
          <h4 class="post-title"><a href='blog-single.html'>{{ __('Your Light Is About To Stop Being Relevant') }}</a></h4>
          <ul class="meta list-inline mb-0">
            <li class="list-inline-item"><a href="#">{{ __('Katen Doe') }}</a></li>
            <li class="list-inline-item">{{ __('29 March 2021') }}</li>
          </ul>
