...
<section class="main-content mt-5">
  <div class="container">
    ...
    @if (auth()->check())
      <h2 class="title">{{ __("Hi, :name", ["name" => auth()->user()->fullname()]) }}, {{ __("Let's Start Learning") }}</h2>
    @else
    ...
    <div class="swiper-wrapper" aria-live="polite">
      @foreach ($courses as $course)
        <div class="swiper-slide swiper-slide-active style-mfekx" role="group" aria-label="1 / 5" data-swiper-slide-index="0">
              ...
              <ul class="courses__item-meta list-wrap">
                ...
                <div class="courses__item-content-bottom">
                  <div class="author-two">
                    <a {{-- href="#" --}}>
                      <img src="{{ $course->user->image_url() }}" alt="{{ $course->user->fullname() }}">{{ $course->user->fullname() }}
                    </a>
                  </div>
                </div>
                <li class="price">
