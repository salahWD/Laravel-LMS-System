            ...
            <div class="card-header d-flex flex-row align-items-center flex-0 border-bottom">
              ...
              <div class="d-block ms-auto">
                <div class="d-flex align-items-center text-end mb-2">
                  ...
                  <span class="fw-normal small">{{ __('July') }}</span>
                </div>
                <div class="d-flex align-items-center text-end">
                  <span class="dot rounded-circle bg-secondary me-2"></span>
                  <span class="fw-normal small">{{ __('August') }}</span>
                </div>
              </div>
            </div>
            ...
            <div class="card-body">
              ...
              <div class="d-block">
                <div class="d-flex align-items-center me-5">
                  ...
                  <div class="d-block">
                    <label class="mb-0">{{ __('Bounce Rate') }}</label>
                ...
                <div class="d-flex align-items-center pt-3">
                  ...
                  <div class="d-block">
                    <label class="mb-0">{{ __('Sessions') }}</label>
                    <h4 class="mb-0">{{ __('9,567') }}</h4>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="card bg-yellow-100 border-0 shadow">
          <div class="card-header d-sm-flex flex-row align-items-center flex-0">
            <div class="d-block mb-3 mb-sm-0">
              ...
              <h2 class="fs-3 fw-extrabold">{{ __('10,567 visitor') }}</h2>
              <div class="small mt-2">
                <span class="fw-normal me-2">{{ __('Yesterday') }}</span>
                <span class="fas fa-angle-up text-success"></span>
                <span class="text-success fw-bold">10.57%</span>
              </div>
            </div>
            <div class="d-flex ms-auto">
              <a href="#" class="btn btn-secondary text-dark btn-sm me-2">{{ __('Month') }}</a>
              <a href="#" class="btn btn-dark btn-sm me-3">{{ __('Week') }}</a>
            </div>
          </div>
          <div class="card-body p-2">
