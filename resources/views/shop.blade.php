                        ...
                        <div class="content">
                            <div class="row">
                                <div class="hidden-xs hidden-sm col-md-6">
                                    <img src="https://planet-17.myshopify.com/cdn/shop/t/9/assets/slide_img_2.png?v=58646201550105743901460189156"
                                        alt="">
                                </div>
                                <div class="col-md-6">
                                    <div class="info">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-9">
                    ...
                    <i class="fa fa-star-half" aria-hidden="true"></i>
                                    ...
                                    <a class="product-buy"
                                        href="{{ route('product_show', $product->id) }}">{{ __('Buy') }}</a>
                                </div>
                            </div>
                        @endforeach
                    </div>
        ...
        <div class="mt-4 mb-5 owl-carousel offers offers-slider m-auto owl-theme custom-nav-icon owl-loaded">
            @foreach ($offers as $offer)
                <div class="offer d-flex">
                    <figure>
                        <img src="//planet-17.myshopify.com/cdn/shop/products/z33_3a4076f1-94b2-4443-aa71-8fbf9f92f2a2_large.png?v=1459702297"
                            alt="Canon EOS-1">
                    </figure>
