            ...
            <div class="content">
              <div class="row">
                <div class="hidden-xs hidden-sm col-md-6">
                  <img src="https://planet-17.myshopify.com/cdn/shop/t/9/assets/slide_img_2.png?v=58646201550105743901460189156" alt="">
                </div>
                <div class="col-md-6">
                  <div class="info">
                    <h3 class="title">get started with products</h3>
                    <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe culpa amet delectus.</p>
  ...
  <section class="main-content">
          ...
          <div class="flex flex-col">
            <ul class="list-group">
              @if (count($categories) > 0)
                ...
                @endforeach
              @else
                <div class="m-0 alert border border-warning rounded alert-warning">{{ __("no categories to show") }}</div>
              @endif
            </ul>
          </div>
        </div>
        <div class="col-xs-12 col-sm-9">
          <div class="owl-carousel products-carousel products owl-theme owl-loaded" data-prev="fa fa-angle-left" data-next="fa fa-angle-right">
    ...
    <div class="mt-4 mb-5 owl-carousel offers offers-slider m-auto owl-theme custom-nav-icon owl-loaded">
      @foreach($offers as $offer)
        <div class="offer d-flex">
          <figure>
            <img src="//planet-17.myshopify.com/cdn/shop/products/z33_3a4076f1-94b2-4443-aa71-8fbf9f92f2a2_large.png?v=1459702297" alt="Canon EOS-1">
          </figure>
          <div class="saletimeout-content text-center">
            ...
            <div class="counter-wrapper" data-target="2016/8/20 23:00:00">
              ...
              <div class="seconds">04<span>sec</span></div></div>
    ...
    <div class="container">
      <div class="bestsales">
        ...
        <div class="owl-carousel bestsales-carousel products owl-theme owl-loaded" data-prev="fa fa-angle-left" data-next="fa fa-angle-right">
          @foreach($new_products as $product)
            <div class="xv-product product style shadow-around">
              <figure>
                <a href="{{ $product->get_link() }}">
              ...
              <div class="package p-4">
                <div class="row align-items-center">
                  <div class="col-xs-12 col-sm-6">
                    <div class="main-product" style="--main-product-padding: @if(app()->getLocale() == "ar") 0 0 0 1.5rem @else 0 1.5rem 0 0 @endif">
                      ...
                      <figure class="shadow">
                        <a href="{{ $product->get_link() }}">
                          <div class="reveal">
                            @if ($product->get_images())
                              @foreach ($product->get_images(2) as $i => $image)
                                <img class="@if ($i == 0) owl-lazy xv-superimage w-100 @else hidden @endif"
                                    src="{{ $image }}"
                                    alt="{{ $product->title }}" @if ($i == 0) style="opacity: 1;" @endif>
                              @endforeach
                            @endif
