          ...
          <div class="text-center">
            @if (!empty($current_lecture->next_item()))
              @if ($current_lecture->next_item()->is_lecture())
                <a id="next-lecture" href="{{ route('lecture_show', $current_lecture->next_item()->itemable_id) }}"
                  class="btn btn-lg border btn-outline-success mt-4 m-auto">{{ __('next lecture') }}</a>
              @else
                <a id="next-lecture" href="{{ route('test_show', $current_lecture->next_item()->itemable_id) }}"
